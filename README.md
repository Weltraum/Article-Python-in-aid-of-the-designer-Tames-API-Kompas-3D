...
После выполнения нашего скрипта, вернём всё на свои места: если Kompas 3D был запущен нами, мы её и закроем. Самый простой способ определить, запущен ли процесс - использовать стандартный модуль subprocess:
...
На самом деле ячейка под №6 для листа с другим оформлением может содержать совсем иную информацию.  Посмотрим, как Kompas 3D определяются стили оформления чертежа:
...
## Заключение
Используя скрипт на чертеже, созданном к данной статье, мы получим следующие результаты: 
   * Количество размеров 25 штук
   * Количество пуктов технических требований 3 штуки
   * Масштаб 1:1
   * Всего 1 лист формата А3
   
Трудозатраты, согласно упомянатому в начале статьи документу по нормативам времени на разработку чертежа, составили 
1 час 20 мину. Как не удивительно, примерно столько и было потрачено времени. Но для внедрения подобных норм на предприятии, нужны более серьёзные исследования и совершенно другие объёмы чертежей. На этом статья закончена, с замечаниями и предложениями к статье открыт к общению.
